...
//    boolean checkenabled=false;
    ...
    public WhReadyParcelAdapter(WhSearchParcelFragment fragment, Context context, List<ParcelListingData.ParcelData> parcelDataList, View.OnClickListener onclickListener) {
    ...
    public WhReadyParcelAdapter(Context context, List<ParcelListingData.ParcelData> parcelDataList, View.OnClickListener onclickListener) {
        this.parcelDataList = parcelDataList;
        this.onclickListener = onclickListener;
        this.context = context;
