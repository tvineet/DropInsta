...
public class AuctionCreateInvoiceFragment extends AuctionBaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
...
//        float cashPrice = Float.parseFloat(""+cash_price_edt.getText());
//
//        float cardPrice = Float.parseFloat(""+card_price_edt.getText());
//        String cardTransactionId = ""+card_transid_edt.getText();
//
//        float chequePrice = Float.parseFloat(""+cheque_price_edt.getText());
//        String chequeTransactionId = ""+cheque_transid_edt.getText();
//
//        float bankTransPrice = Float.parseFloat(""+bank_price_edt.getText());
//        String bankTransactionId = ""+bank_transid_edt.getText();
...
//            Toast.makeText(activity(),getString(R.string.item_scan_error_msg),Toast.LENGTH_LONG).show();
            SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.item_scan_error_msg));
            return false;
        }else if(!isValidString(custName)){
//            Toast.makeText(activity(),"pls enter Customer Name",Toast.LENGTH_LONG).show();
            SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.customer_name_error_msg));
            return false;
        }else if(!isValidString(custPhone)){
//            Toast.makeText(activity(),"pls enter Customer Phone number",Toast.LENGTH_LONG).show();
            SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.customer_phone_error_msg));
            return false;
        }else if(!isValidString(custEmail)){
//            Toast.makeText(activity(),"pls enter Customer email",Toast.LENGTH_LONG).show();
            SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.customer_email_error_msg));
            return false;
...
//            Toast.makeText(activity(),"pls select one payment method.",Toast.LENGTH_LONG).show();
            SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.payment_mode_error_msg));
            return false;
        }else{
...
//                Toast.makeText(activity(),"pls enter cash value.",Toast.LENGTH_LONG).show();
                SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.cash_val_error_msg));
                return false;
            }else{
...
//                Toast.makeText(activity(),"pls enter card value.",Toast.LENGTH_LONG).show();
                SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.card_val_error_msg));
                return false;
...
//                Toast.makeText(activity(),"pls enter card Transaction id.",Toast.LENGTH_LONG).show();
                SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.card_transactionid_error_msg));
                return false;
            }else{
...
//                Toast.makeText(activity(),"pls enter cheque value.",Toast.LENGTH_LONG).show();
                SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.cheque_val_error_msg));
                return false;
...
//                Toast.makeText(activity(),"pls enter cheque Transaction id.",Toast.LENGTH_LONG).show();
                SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.cheque_transactionid_error_msg));
                return false;
            }else{
...
//                Toast.makeText(activity(),"pls enter Bank Transfer value.",Toast.LENGTH_LONG).show();
                SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.bank_val_error_msg));
                return false;
...
//                Toast.makeText(activity(),"pls enter Bank Transfer Transaction id.",Toast.LENGTH_LONG).show();
                SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.bank_transactionid_error_msg));
                return false;
            }else{
        ...
        if(grandTotal >= receivedAmount){
            SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.invoice_amount_error_msg));
            return false;
        }
...
//                                Toast.makeText(activity(), "This item already scanned", Toast.LENGTH_LONG).show();
                                SweetAlertUtil.showSweetMessageToast(getActivity(),getString(R.string.item_scanned_error_msg));
                            }
